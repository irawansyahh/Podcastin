...
import 'package:Podcastin/ui/podcast/player_position_controls.dart';
import 'package:Podcastin/ui/podcast/player_transport_controls.dart';
...
class _NowPlayingState extends State<NowPlaying> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    playingStateSubscription =
        audioBloc.playingState.listen((playingState) async {
