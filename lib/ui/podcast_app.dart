  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: theme,
        home: PodcastinHomePage(title: 'Podcastin'),
      ),
    );
  }
}
...
class _PodcastinHomePageState extends State<PodcastinHomePage>
    ...
    switch (choice) {
      case 'about':
        showAboutDialog(
            ...
            children: <Widget>[
              Text('\u00a9 2020 @irawansyahhhh'),
              GestureDetector(
                  child: Text('irawansyah@student.telkomunviersity.ac.id',
                      style: TextStyle(
  ...
  void _launchEmail() async {
    const url = 'irawansyah@student.telkomunviersity.ac.id';
